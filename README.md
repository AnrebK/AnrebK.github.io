...
<html>
    <head>
        ...
        <meta charset="utf-8">
        <style>
        body {background-color:rgb(176, 207, 194);}
        h1 {color:rgb(196, 37, 132);}
        h2{color: rgb(65, 70, 105);}
        #ingredientespanqueques {background-color:rgb(143, 163, 121); }
        #ingredienteswaffles{background-color:rgb(143, 163, 121);}
        #ingredientescrepes{background-color:rgb(143, 163, 121);}
        .elaboracion{background-color:rgb(76, 189, 189);}
    ...
    <body>
        ...
        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/09/Crepes_dsc07085.jpg/800px-Crepes_dsc07085.jpg"width="200">
        ...
        <table id="ingredientespanqueques">
            <thead>
                <tr>
                    <th>Ingredientes</th>
                    <th>Cantidad</th>
